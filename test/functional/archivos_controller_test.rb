...
class ArchivosControllerTest < ActionController::TestCase
  ...
  test "should create archivo" do
    assert_difference('Archivo.count') do
      post :create, archivo: { descripcion: @archivo.descripcion, fcreado: @archivo.fcreado, nombre: @archivo.nombre }
    end
  ...
  test "should update archivo" do
    put :update, id: @archivo, archivo: { descripcion: @archivo.descripcion, fcreado: @archivo.fcreado, nombre: @archivo.nombre }
    assert_redirected_to archivo_path(assigns(:archivo))
  end
